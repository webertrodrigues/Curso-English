...
const quizConfig = {
    ...
    correctAnswers: {
        q1: 'a', // Soccer
        q2: 'a', // Natação
        q3: 'a', // What do you do to stay active?
        q4: 'b', // Racket and ball
        q5: 'a', // Gym
        q6: 'b'  // Weight lifting
    },
    explanations: {
        q1: {
            correct: 'Correto! "Soccer" é como o futebol é chamado nos EUA.',
            incorrect: 'Errado! Nos EUA, futebol é chamado de "Soccer".'
        },
        q2: {
            correct: 'Correto! "Swimming" significa natação em português.',
            incorrect: 'Errado! "Swimming" significa natação, não corrida ou ciclismo.'
        },
        q3: {
            correct: 'Correto! "What do you do to stay active?" é como perguntar sobre atividades físicas.',
            incorrect: 'Errado! "What do you do to stay active?" é a pergunta correta sobre atividades físicas.'
        },
        q4: {
            correct: 'Correto! Para jogar tênis você precisa de raquete e bola.',
            incorrect: 'Errado! Para tênis você precisa de raquete e bola.'
        },
        q5: {
            correct: 'Correto! "Gym" significa academia em inglês.',
            incorrect: 'Errado! "Gym" é a palavra correta para academia.'
        },
        q6: {
            correct: 'Correto! "Weight lifting" é a atividade de levantar pesos.',
            incorrect: 'Errado! "Weight lifting" é a atividade que envolve levantar pesos.'
        }
    }
};
...
const dialogueLines = [
    "Hey, what do you usually do to stay active?",
    "I love to run! I go running in the park every morning. What about you?",
    "I enjoy playing basketball with my friends on weekends. It's a great way to exercise and have fun.",
    "That sounds cool! Do you also go to the gym?",
    "Sometimes, I go to lift weights. But my main activity is basketball.",
    "Have you ever tried yoga? I do it twice a week. It helps me relax."
];
...
function getScoreMessage(score, total) {
    ...
    if (percentage >= 90) return '🏆 Excelente! Você domina o vocabulário de esportes!';
    if (percentage >= 70) return '👍 Muito bom! Você tem um conhecimento sólido sobre esportes!';
